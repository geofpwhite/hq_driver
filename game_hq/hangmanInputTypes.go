...
func (ui *usernameInput) ChangeState(gameObj *Game) {
...
func (nwi *newWordInput) ChangeState(gameObj *Game) {
	gState := (*gameObj).(*hangman)
...
func (gi *guessInput) ChangeState(gameObj *Game) {
	gState := (*gameObj).(*hangman)
...
func (ci *chatInput) ChangeState(gameObj *Game) {
	gState := (*gameObj).(*hangman)
...
func (rcwi *randomlyChooseWordInput) ChangeState(gameObj *Game) {
	gState := (*gameObj).(*hangman)
...
func (cgi *closeGameInput) ChangeState(gameObj *Game) {
}
